...
CSV_LIST = [SQUAT1 + EXTENSIONS[Extension.csv], SQUAT2 + EXTENSIONS[Extension.csv], SQUAT3 + EXTENSIONS[Extension.csv], RIGID_BODY + EXTENSIONS[Extension.csv], SQUAT4 + EXTENSIONS[Extension.csv]]
